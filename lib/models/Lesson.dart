...
class Lesson extends amplify_core.Model {
  ...
  const Lesson._internal({required this.id, required description, required title, createdAt, updatedAt}): _description = description, _title = title, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Lesson({String? id, required String description, required String title}) {
  ...
  Lesson copyWith({String? description, String? title}) {
    return Lesson._internal(
      id: id,
